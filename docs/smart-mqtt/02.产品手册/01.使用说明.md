...
| 数据桥接 -- redis  | ❌        | ✅                                     |
| 数据桥接 -- kafka  | ❌        | ✅                                     |
| Dashboard      | ❌        | ✅ [在线体验](http://115.190.30.166:8083/) |
...
- **纯国产血统**（符合信创场景需求）
    ...
    - http服务为亦是自研的 [Feat](https://smartboot.tech/feat)
...
smart-mqtt 依托于 Feat 提供的 websocket 能力，成功的将基于 websocket 协议的 MQTT 消息接入 Broker。
...
### 5.3 关于授权
smart-mqtt 提供永久授权方案，一次性付费即可永久使用。
...
- 我们不是一家企业，而是专注于技术的开源组织，有限的精力难以保障周到的售后服务。体验版所见之能力，便是商业授权之所得。决定购买授权前，请充分验证体验版功能是否符合自身要求。
- 您所购买的是 smart-mqtt 当前能力的永久使用权。请不要提一些额外的需求，除非符合 smart-mqtt 今后的发展路线。
- 充分理解并同意我们的[免责声明](#_5-2-免责申明)。
