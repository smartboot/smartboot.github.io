  ...
  smart-mqtt-bench:
    ...
    logging:
      ...
      options:
        max-size: "100m"
        max-file: "1"
    command: java -cp smart-mqtt-bench.jar  -Dhost=emqx-mqtt -Dconnect=1000 -Dpublisher=2 -Dcount=3 -Dpayload=128 org.smartboot.bench.mqtt.Subscribe
version: '3.7'
```
  ...
  smart-mqtt-bench:
    ...
    logging:
      ...
      options:
        max-size: "100m"
        max-file: "1"
    command: java -cp smart-mqtt-bench.jar  -Dhost=smart-mqtt -Dconnect=1000 -Dpublisher=2 -Dcount=3 -Dpayload=128 org.smartboot.bench.mqtt.Subscribe
version: '3.7'
```
